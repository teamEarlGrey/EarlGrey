      ...
      <div className={`flex-row mt-20 text-center relative`}>
        ...
        >
          <div className={`flex-col `}>
            <div
              className={`w-[120px] h-[113px] border-2 border-[#000] my-0.5 ml-0.5 px-1 py-[20px]`}
            >
              2503デッサン教室（ノートPC対応教室）
            </div>
            <div
              className={`w-[120px] h-[113px] border-2 border-[#000] my-0.5 ml-0.5 px-1 py-[20px]`}
            >
              2504デッサン教室（ノートPC対応教室）
            </div>
            <div
          ...
          <div className={`flex-col`}>
            ...
            <div
              className={`w-[153px] h-[116px] border-2 border-[#000] m-0.5 absolute py-[45px]`}
            >
              2502実習室
            </div>
          </div>
